                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="card m-b-30">
                                    <div class="card-body table-responsive">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-sm-6">
                                                <a href="<?= site_url('kasus_dbd/tambah'); ?>" class="btn btn-primary mb-3 ml-3 waves-effect waves-light">
                                                    <i class="fa fa-plus pr-1"></i> Tambah
                                                </a>
                                            </div>
                                            <div class="col-sm-6 mx-auto">
                                                <form action="<?= base_url('kasus_dbd/cari') ?>" method="POST">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <a href="<?= site_url(); ?>kasus_dbd/hapus/<?= $kps['id'] ?>" class="btn btn-danger btn-sm tombol-hapus" data-toggle="tooltip" data-placement="top" title="Hapus Data">
