                                        ...
                                        <form action="" method="post">
                                            <div class="card-body">
                                                ...
                                                <?php if ($this->input->post('filterTahun')) : ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="jumlah">Jumlah Kasus Malaria</label>
                                                        <input type="text" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah Kasus Positif Malaria" value="<?= set_value('jumlah'); ?>">
                                                    </div>
                                                    <div class="ml-4">
